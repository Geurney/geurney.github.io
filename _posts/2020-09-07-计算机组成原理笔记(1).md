...
从正数得到负数的方法是各位取反然后加1，即得到补码表示，见[相反数](#相反数))。
...
### signed和unsigned的转化
同样的n bit pattern，sign和unsign差了2^w: `0x1111U-0x1111=15-(-1)=16=2^4;`
...
INT_MAX = |INT_MIN| - 1    
INT_MAX的相反数是INT_MIN+1  `0x0111->0x1000->0x1001`    
